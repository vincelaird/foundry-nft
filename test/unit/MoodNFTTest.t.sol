...
contract MoodNFTTest is Test {
    ...
    function testViewTokenURI() public {
        ...
        // Can add more specific checks for the tokenURI content if needed
    }
    ...
    function testFlipMoodRevertUnauthorized() public {
        vm.prank(USER);
        moodNFT.mintNFT();
    ...
    function testMintMultipleNFTs() public {
        ...
        assertEq(moodNFT.balanceOf(ANOTHER_USER), 1);
        assertEq(moodNFT.getTokenCounter(), 2);
    }

    function testTokenURIForNonexistentToken() public {
        vm.expectRevert(MoodNFT.MoodNFT__TokenDoesNotExist.selector);
        moodNFT.tokenURI(999);
    }

    function testConstructor() public view {
        assertEq(moodNFT.getSadSVGImageURI(), SAD_SVG_URI);
        assertEq(moodNFT.getHappySVGImageURI(), HAPPY_SVG_URI);
    }
}